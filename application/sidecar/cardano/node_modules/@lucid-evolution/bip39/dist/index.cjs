...
var Sha256 = () => (0, import_crypto.createHash)("sha256");
...
function mnemonicToEntropy(mnemonic, wordlist) {
  ...
  return (0, import_core_utils.toHex)(entropy);
}
  ...
  if (size > 0) {
    if (size > MAX_BYTES) {
      for (let generated = 0; generated < size; generated += MAX_BYTES) {
        import_crypto.webcrypto.getRandomValues(
          bytes.slice(generated, generated + MAX_BYTES)
        );
      }
    } else {
      import_crypto.webcrypto.getRandomValues(bytes);
    }
  }
  return bytes;
}
